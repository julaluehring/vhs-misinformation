...
-   **1-6% in 5 Studien von 2016-2019**: kleiner Anteil des Online-Nachrichtenkonsums (in den USA!)

-   in Krisen: Rückgriff auf zuverlässige Nachrichten
...
-   Misinformation überlappt mit Konflikten zwischen sozialen Gruppen und damit zusammenhängender [Hassrede](https://doi.org/10.1093/pnasnexus/pgae111)
...
-   Nutzer suchen auf andere Weise gleichgesinnte Inhalte
...
Untersuchung von politischer Polarisierung in den USA
...
::: {.column width="50%"}
-   mehr Inhalte von Meinungsführern der anderen Partei
